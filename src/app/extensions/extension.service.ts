...
export class AppExtensionService implements RuleContext {
  ...
  colProps:any = [
    ...
    {
      "id": "bt.id.fiscalYear",
      "key": "properties.bt:fiscalYear",
      "title": "BT.FISCAL_YEAR",
      "type": "text",
      "class": "adf-data-table-cell--ellipsis",
      "sortable": true,
      "desktopOnly": true
...
console.log(this.colProps,"colPropscolProps")
    this.documentListPresets = {
      files: this.colProps,
      //this.getDocumentListPreset(config, 'files'),
    ...
    console.log(this.documentListPresets,"documentListPresets");
